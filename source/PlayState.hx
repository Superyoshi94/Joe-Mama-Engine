...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		add(scoreTxt);
		missTxt = new FlxText(FlxG.width / 2 - 135, healthBarBG.y + 50, 0, "", 20);
		missTxt.setFormat("assets/fonts/vcr.ttf", 16, FlxColor.WHITE, RIGHT);
		missTxt.scrollFactor.set();
		add(missTxt);
		comboTxt = new FlxText(FlxG.width / 2 - 35, healthBarBG.y + 50, 0, "", 20);
		comboTxt.setFormat("assets/fonts/vcr.ttf", 16, FlxColor.WHITE, RIGHT);
